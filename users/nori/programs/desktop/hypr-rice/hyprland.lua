...
-- Translated from users/nori/programs/desktop/hypr-rice/default.nix's
...
hl.config({
    -- Norwegian keymap to mirror infra/common/nixos/base.nix.
...
-- wrapping. `layer-cycle` (users/nori/programs/desktop/hypr-rice/default.nix) tracks which
