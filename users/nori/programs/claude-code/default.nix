...
/**
  ...
  provider-neutral SOUL is owned by users/nori/programs/agent-soul; global
  skills are owned by users/nori/programs/agent-skills. Dynamic state
...
let
  ...
  */
  ...
  /*
    ...
    entrypoint fans out to ntfy — see users/nori/programs/agent-notify/default.nix.
  */
...
in
{
  ...
  home.file = lib.mkMerge [
    ...
    # users/nori/programs/agent-skills. Only Claude's lifecycle adapter belongs here.
