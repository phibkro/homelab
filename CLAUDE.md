...
- **Channel**: `nixos-25.11` stable (switched from unstable 2026-04-29). Ships NVIDIA driver 580.142 (LTS line) + kernel 6.12.83. Re-pin to 26.05 when next stable cuts ~May 2026. The original "unstable for Blackwell driver" rationale dissolved when 25.11 was cut Nov 2025 with full Blackwell support.
