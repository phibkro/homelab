...
| `docs/reference/topology-generated.md` | looking up the hosts-at-a-glance table or `nori.hosts` schema — generated from `flake.nix:identityFor` + `modules/effects/hosts.nix` via `nix build .#docs-topology` (the hand-written `topology.md` keeps the curated overview, diagram, and invariants) |
