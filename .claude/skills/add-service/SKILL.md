...
Read `docs/reference/module-authoring.md`, `src/inventory/workloads.nix` and one
...
`src/services/<service>/manifest.nix` and its implementation in `nixos.nix`. Reuse
