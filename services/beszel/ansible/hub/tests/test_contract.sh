...
rg -q 'beszel_healthcheck_command.*to_json' "$role_dir/tasks/main.yml" \
  || fail "exec-form container healthcheck is missing"
rg -q 'http://127\.0\.0\.1:8090' "$role_dir/defaults/main.yml" \
