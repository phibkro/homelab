...
in
{
  ...
  */
  ...
  /**
    ...
    implementation/dashboards/. The Grafana DB at /var/lib/grafana still
      ...
      */
      ...
      datasources.settings.datasources = [
        ...
        }
        {
          name = "VictoriaMetrics";
          /*
            Stable UID so provisioned dashboards under implementation/
            dashboards/ can reference this datasource by uid without
            having to discover the auto-generated value at runtime.
            The Gatus dashboard (implementation/dashboards/gatus.json)
            uses this exact uid.
          */
          uid = "victoriametrics";
          /*
      ...
      dashboards.settings.providers = [
        {
          name = "Default";
          folder = "Lab";
          options.path = ./implementation/dashboards;
