...

{
  /*
    ...
    from nori.fs entries via infra/common/nixos/storage/default.nix:
      ...
      share → /srv/share   (emitted by nori.fs.share.samba — declared
                             alongside disko at infra/workstation/disko.nix)
  ...
  */
    ...
    settings = lib.mkMerge [
      {
        ...
        /*
          ...
          infra/common/nixos/storage/default.nix from the per-fs `samba = { … }`
  ...
  /*
    ...
    tmpfiles via infra/common/nixos/storage/default.nix; the four below cover the
