...
in
{
  /**
    ...
    DNS path: Blocky's customDNS (services/blocky/nixos.nix) maps
  ...
  services.caddy = {
    ...
    */
    ...
    /**
      ...
      module — see infra/common/nixos/routes.nix for the option +
  ...
  */
  ...
  /*
    ...
    to nori.lanIp (set in infra/common/nixos/routes.nix), requests
