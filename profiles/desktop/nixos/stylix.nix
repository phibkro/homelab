...

{
  /*
    ...
    users/nori/workstation.nix (gtk = { ... }, qt = { ... },
  ...
  stylix = {
    ...
    */
    ...
    /*
      ...
      system level via profiles/desktop/nixos/fonts.nix. Stylix wires these
    ...
    */
    ...
    /*
      ...
      users/nori/programs/desktop/hypr-rice/runtime.nix `stylix.targets.<X>.enable`.
    */
