...

{
  ...
  */
  ...
  /*
    ...
    src/infra/common/nixos/base.nix). Two roles:
      ...
      2. Hibernation target — the kernel writes a compressed image of
         ...
         predates the RAM upgrade recorded in `src/inventory/hosts.nix`;
    ...
    Disko does not create this file. The bare-metal install procedure creates
    it and refreshes the filesystem UUID and resume offset before installation.
  ...
  */
  ...
  /*
    ...
    accelerationDevices / DeviceAllow. Default in src/infra/common/nixos/gpu.nix
