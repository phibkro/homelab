...
`src/inventory/`; the Pi generator translates public inventory into Ansible input.
The generator is `src/infra/pi/scripts/generate-inventory.sh`; `src/infra/pi/playbooks/pi.yml`
