...

{
  ...
  */
  ...
  /*
    ...
    starship, etc.) lives in src/profiles/home/core.nix — every host
    NixOS hosts import `src/users/nori/home.nix`, which pulls in core, so nori on
  ...
  */
  ...
  /*
    ...
    (default), its logical capacity scales with each host's RAM.
    Physical memory use depends on the amount swapped and compression.
  ...
  */
  ...
  /*
    ...
    See src/infra/common/nixos/inventory.nix for the typed host projection.
