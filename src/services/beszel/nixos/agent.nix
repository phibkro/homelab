...
let
  agentPort = config.nori.inventory.workloads."beszel-agent".listeners.agent.port;
in
{
  /**
  ...
  */
  ...
  /*
    ...
    nori.gpu.nvidiaDevices (see src/infra/common/nixos/gpu.nix) the agent surfaces
