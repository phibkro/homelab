...

{
  /*
    ...
    src/users/nori/workstation.nix (gtk = { ... }, qt = { ... },
  ...
  stylix = {
    ...
    */
    ...
    /*
      ...
      system level via src/profiles/desktop/nixos/fonts.nix. Stylix wires these
    ...
    */
    ...
    /*
      ...
      src/users/nori/programs/desktop/hypr-rice/runtime.nix `stylix.targets.<X>.enable`.
    */
