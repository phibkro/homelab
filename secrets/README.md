...
form by sops-nix at activation time. To enroll a host:

```bash
# 3. Get the host's age public key (run from any machine):
ssh-keyscan -t ed25519 <host> | ssh-to-age
# Or, if you're on the host already:
