  ...
  config = mkIf (localAppliances != { }) {
    ...
    */
    ...
    networking.nftables.tables.tailnet-appliance = {
      family = "ip";
      content = ''
        # PREROUTING DNAT: rewrite outbound :53 from each appliance to  # multi-line: ok (nftables syntax)
        ...
        # FORWARD drop: block appliance traffic to known public-resolver  # multi-line: ok (nftables syntax)
