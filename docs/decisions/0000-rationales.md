...
| **Blocky over AdGuard Home** | AdGuard Home | Declarative YAML config maps cleanly to `services.blocky.settings`; no web-UI state to drift from declared config. | `modules/infra/networking/blocky.nix` |
