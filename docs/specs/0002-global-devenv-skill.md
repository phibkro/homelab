...
- `nix/home/agent-skills/devenv/SKILL.md`
- `nix/home/agent-skills/devenv/agents/openai.yaml`
- `nix/home/agent-skills/devenv/references/capability-map.md`
- `nix/home/agent-skills/devenv/references/environment-and-toolchains.md`
- `nix/home/agent-skills/devenv/references/automation.md`
- `nix/home/agent-skills/devenv/references/composition.md`
- `nix/home/agent-skills/devenv/references/operations.md`
- `nix/home/agent-skills/devenv/references/integrations.md`
- `nix/home/agent-skills/devenv/references/inspection-and-debugging.md`
- `nix/home/agent-skills/devenv/references/version-boundaries.md`

## Registry contract

Register the directory with the existing `bothSurfaces "devenv"` helper in
`nix/home/agent-skills/default.nix`. Do not add another top-level skill for
