...
| `ntfy-service` | `service` | `ntfy-server` | `pi` | `filesystem` | `ntfy` | `onetouch` | `/var/cache/ntfy`<br>`/var/lib/ntfy` | — | `restore`<br>`integrity`<br>`startup`<br>`endpoint` | [report](../archive/reports/2026-09-21-ntfy-recovery-drill.md) |
