> Historical proposal; do not execute as a current runbook. This unimplemented proposal targets retired Aurora and has not been adapted or approved for workstation. Grafana runtime currently retains anonymous authentication behind its declared network boundary.
...
### 3. Edit `nix/modules/system/observability/grafana/runtime.nix`
