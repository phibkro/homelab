...
> `git diff --stat 0cef85b..HEAD -- tests/tests.just nix/modules/system/observability/disk-alert.nix tests/e2e-disk-alert.nix docs/reference/runtime-tests.md`
...
- **Effort**: S–M
- **Risk**: MED
- **Depends on**: `docs/archive/legacy-plans/006-fail-closed-backup-runtime-tests.md`, `docs/archive/legacy-plans/008-run-replica-verifiers-now.md` (shared runtime helpers and `tests/tests.just`)
- **Category**: bug, tests
...
```nix
# nix/modules/system/observability/disk-alert.nix:77-108
...
- `nix/modules/system/observability/disk-alert.nix`
