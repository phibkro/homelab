...
> `git diff --stat 0cef85b..HEAD -- nix/modules/system/backup/backup.just docs/reference/services.md README.md`
...
```just
# nix/modules/system/backup/backup.just:14-19
@backup repo:
...
```text
# nix/modules/system/backup/default.nix:53-56
...
- Manual recipes live beside the concern in `nix/modules/system/backup/backup.just`.
...
- `nix/modules/system/backup/backup.just`
...
```bash
rg 'just backup|restic-backups-<repo>' README.md docs/reference/services.md nix/modules/system/backup/backup.just
```
