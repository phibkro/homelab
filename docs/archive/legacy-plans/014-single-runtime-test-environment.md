...
- **Effort**: M–L
- **Risk**: LOW
- **Depends on**: `docs/archive/legacy-plans/006-fail-closed-backup-runtime-tests.md`, `docs/archive/legacy-plans/008-run-replica-verifiers-now.md`, `docs/archive/legacy-plans/010-fail-closed-observability.md`, `docs/archive/legacy-plans/012-verify-authelia-client-registry.md`, `docs/archive/legacy-plans/013-repair-active-documentation.md`
- **Category**: perf, dx
...
Base system packages include `dig` but not the full runtime-test toolset (`nix/modules/system/base/base.nix:98-109`). Do not solve this by globally installing every test dependency on every host; provision a concern-specific environment.
...
- `docs/archive/legacy-plans/014-single-runtime-test-environment.md` — append execution measurements and final acceptance/rejection outcome
