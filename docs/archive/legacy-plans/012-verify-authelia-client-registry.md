...
> `git diff --stat 0cef85b..HEAD -- tests/tests.just tests/runtime/assertions.sh tests/runtime/assertions.test.sh nix/modules/system/access/authelia.nix docs/reference/runtime-tests.md`
...
- **Effort**: M
- **Risk**: MED
- **Depends on**: `docs/archive/legacy-plans/006-fail-closed-backup-runtime-tests.md`, `docs/archive/legacy-plans/010-fail-closed-observability.md` (serializes shared runtime helpers and `tests/tests.just`)
- **Category**: tests
...
- `nix/modules/system/access/authelia.nix:179-188` generates `identity_providers.oidc.clients` from route declarations.
...
- `nix/modules/system/access/authelia.nix` — comments only if needed
