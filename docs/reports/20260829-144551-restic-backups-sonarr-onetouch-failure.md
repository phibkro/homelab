---
summary: fix-agent produced no output for restic-backups-sonarr-onetouch — manual thread required
---

# restic-backups-sonarr-onetouch failed — fix-agent could not act
