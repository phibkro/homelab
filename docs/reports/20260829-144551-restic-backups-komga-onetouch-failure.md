---
summary: fix-agent produced no output for restic-backups-komga-onetouch — manual thread required
---

# restic-backups-komga-onetouch failed — fix-agent could not act
