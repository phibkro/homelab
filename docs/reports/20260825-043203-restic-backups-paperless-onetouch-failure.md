---
summary: fix-agent produced no output for restic-backups-paperless-onetouch — manual thread required
---

# restic-backups-paperless-onetouch failed — fix-agent could not act
